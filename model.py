...
class pix2pix(object):
    ...
    def build_model(self):
        ...
        self.mouth_image_real_data = tf.placeholder(tf.float32,
                                              [self.batch_size, self.mouth_image_size, self.mouth_image_size,
                                                self.mouth_image_c_dim],
                                                name='mouth_image_real_data')
        self.mouth_voice_real_data = tf.placeholder(tf.float32,
                                                    [self.batch_size,self.mouth_voice_dimen, self.mouth_voice_time_dim, 1],
        ...
        self.fake_mouth = self.generatorForMouth(self.mouth_image_real_data,self.mouth_voice_real_data)
    ...
    def generatorForMouth(self,image,voice,y=None):

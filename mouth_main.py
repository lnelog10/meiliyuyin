...
parser.add_argument('--fine_size', dest='fine_size', type=int, default=112, help='then crop to this size')
parser.add_argument('--voice_dimension', dest='voice_dimension', type=int, default=12, help='the voice data dimension')
parser.add_argument('--voice_time_dim', dest='voice_time_dim', type=int, default=35, help='the voice data time dimension')
